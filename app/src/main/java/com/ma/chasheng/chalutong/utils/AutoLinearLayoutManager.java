...
public class AutoLinearLayoutManager extends GridLayoutManager {
    ...
    public AutoLinearLayoutManager(Context context, int spanCount) {
        super(context, spanCount);
    }

    public AutoLinearLayoutManager(Context context, int spanCount, int orientation, boolean reverseLayout) {
