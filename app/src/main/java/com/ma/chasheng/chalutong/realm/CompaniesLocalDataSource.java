...
import com.ma.chasheng.chalutong.utils.RealmUtil;
...
public class CompaniesLocalDataSource implements CompaniesDataSource {
    ...
    public CompaniesLocalDataSource() {
    }
    ...
    @Override
    public Observable<List<Company>> getCompaines() {
        Realm rlm=RealmUtil.newRealmInstance();
        return Observable.fromIterable(rlm.copyFromRealm(rlm.where(Company.class).findAllSorted("alphabet", Sort.ASCENDING)))
                .toList()
                .toObservable();
    }
    ...
    public Observable<Company> getCompany(@NonNull String companyId) {
        ...
        return Observable.just(rlm.copyFromRealm(rlm.where(Company.class).equalTo("id",companyId).findFirst()));
    }
    ...
    public Observable<List<Company>> searchCompanies(@NonNull String keyWords) {
        ...
        //findAllSorted()返回一个排好序之后的结果集合，findAllAsync()会在后台线程中异步的完成查询操作。
